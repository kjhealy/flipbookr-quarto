...
- `chunk_reveal()` takes up to three new arguments. These are:
...
- `lcolw` and `rcolw`: left and right column widths 
  ...
  - These arguments do nothing in the `xargingan` case
...
- For now the forked `{{flipbookr}}` repo is at <https://github.com/kjhealy/flipbookr>
